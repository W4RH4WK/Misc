...
bool array_resize(struct array *array, size_t new_size) {
...
void *array_get(const struct array *array, size_t index) {
    if (index > array->size) {
        return NULL;
    }
...
bool array_set(struct array *array, size_t index, void *data) {
    if (index > array->size) {
        return false;
    }
